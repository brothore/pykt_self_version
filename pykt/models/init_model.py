...
from .CTNKT import CTNKT

from .TCN_ABQR import TCN_ABQR
...
def init_model(model_name, model_config, data_config, emb_type):
    ...
    elif model_name == "CTNKT":
        model = CTNKT(data_config["num_c"],model_config, emb_type=emb_type).to(device)
    elif model_name == "TCN_ABQR":
        model = TCN_ABQR(data_config["num_c"],**model_config, emb_type=emb_type,num_q=data_config["num_q"]).to(device)
    ...
    elif model_name == "atakt_dual":
        model = ATAKT_DUAL(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
    ...
    elif model_name == "aktb":
        model = AKTB(data_config["num_c"], data_config["num_q"], **model_config, emb_type=emb_type, emb_path=data_config["emb_path"]).to(device)
