...
dname2paths = {
    ...
    "bridge2algebra2006": "/root/autodl-tmp/pykt_self_version/data/bridge2algebra2006/bridge_to_algebra_2006_2007_train.txt",
    "statics2011": "../data/statics2011/AllData_student_step_2011F.csv",
    "nips_task34": "/root/autodl-tmp/pykt_self_version/data/nips_task34/train_task_3_4.csv",
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d","--dataset_name", type=str, default="bridge2algebra2006")
    parser.add_argument("-f","--file_path", type=str, default="../data/peiyou/grade3_students_b_200.csv")
    parser.add_argument("-m","--min_seq_len", type=int, default=1)
