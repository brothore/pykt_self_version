...
def main(params):
    ...
    with open("../configs/kt_config.json") as f:
        ...
        if model_name in ["dkvmn","deep_irt", "sakt", "saint","saint++", "akt", "Transformer_Template","folibikt", "atkt", "lpkt", "skvmn", "dimkt","BERT","atakt","atakt_dual","aktb"]:
    ...
    if model_name == "rkt":
        ...
        model_config["num_q"] = data_config[dataset_name]['num_q']
        print("entered here2")
        print(f"model_config2: {model_config}")
