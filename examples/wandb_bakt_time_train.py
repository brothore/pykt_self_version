...
#     parser.add_argument("--emb_type", type=str, default="qidtrue")
...
#     parser.add_argument("--kernel_list", type=str, default="[3,5]")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--loss3", type=float, default=0.5)
    parser.add_argument("--start", type=int, default=50)
    parser.add_argument("--freq", type=bool, default=True)
