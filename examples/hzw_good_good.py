...
# 加载映射 JSON 文件
json_file_path = "/share/disk/hzb/dataset/assistment2009/keyid2idx.json"  # 替换为你的 JSON 文件路径
...
# 加载 CSV 文件
csv_file_path = "/share/disk/hzb/dataset/assistment2009/ques_skills.csv"  # 替换为你的 CSV 文件路径
...
adj_matrix_normalized = adj_matrix
...
torch.save(adj_tensor, '/share/disk/hzb/dataset/assistment2009/ques_skill_gcn_adj.pt')
